...
export default function PlatformDownloadButtons({ iosUrl, androidUrl, appName, appId, accentHsl }: PlatformDownloadButtonsProps) {
    ...
    <div className="flex items-center justify-center gap-3 flex-wrap">
      {androidUrl && (
        <button
          ...
          className="inline-flex items-center gap-2.5 h-12 px-5 rounded-xl bg-foreground text-background font-semibold text-sm hover:opacity-90 transition-opacity"
        >
