...
const founderPhoto = '/assets/founder-ayushya.jpg';
...
const cultureImages = [
  { src: '/assets/culture/team-collab.jpg', alt: 'Team collaborating in office' },
  { src: '/assets/culture/innovation.jpg', alt: 'Brainstorming and innovation session' },
  { src: '/assets/culture/remote-work.jpg', alt: 'Remote work setup' },
  { src: '/assets/culture/team-fun.jpg', alt: 'Team fun outing' },
];
