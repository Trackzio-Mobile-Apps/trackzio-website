...
export default function Blog({ blogs, blogOfTheWeek }: BlogProps) {
  ...
  const splitFiltered = useMemo(() => {
    if (showAllCategories) return blogs;
    return blogs.filter((a) => a.category === activeSplitCategory);
  }, [activeSplitCategory, showAllCategories, blogs]);
            ...
            >
              ...
              <div className="md:w-1/2 p-8 sm:p-10 flex flex-col justify-center">
                ...
                <div className="flex items-center gap-4 mb-6">
                  <span className="text-xs text-muted-foreground">{blogOfTheWeek.dateDisplay}</span>
                    ...
                    splitFiltered.map((article, i) => (
                      ...
                      >
                        ...
                        <p className="text-xs text-muted-foreground">
                          {article.author} · {article.dateDisplay}
                        </p>
                      </button>
                    ))
                  )}
