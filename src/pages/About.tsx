...
const journeyStages = [
  {
    icon: Search,
    title: 'Problem',
    description: 'We recognised a problem in everyday life.',
  },
  {
    icon: Lightbulb,
    title: 'Idea',
    description: 'We started working on a meaningful solution.',
  },
  {
    icon: Rocket,
    title: 'Beta',
    description: 'We built the beta version of our first products.',
  },
  {
    icon: Users,
    title: 'Early Users',
    description: 'People started using our apps and sharing feedback.',
  },
  {
    icon: TrendingUp,
    title: 'Growing Ecosystem',
    description: 'We continue building products that make people\'s lives easier.',
  },
];
    ...
    <div className="snap-y snap-mandatory">
        ...
        <div className="container-site">
          <motion.div {...fadeUp} className="max-w-3xl mx-auto text-center">
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-6xl lg:text-7xl font-bold font-display leading-[1.1] tracking-tight mb-8"
            >
              Building apps that
              <br />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24">
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl font-bold font-display mb-5 leading-snug">
                  Empowering everyday life through intelligent technology
                </h2>
                <p className="text-muted-foreground leading-relaxed">
                  We envision a world where technology works seamlessly in the background — helping you make better decisions, learn something new, or build a healthier habit. With millions of downloads across our portfolio, we're just getting started.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <h2 className="text-2xl sm:text-3xl font-bold font-display mb-5 leading-snug">
                  Creating tools people love to use every day
                </h2>
                <p className="text-muted-foreground leading-relaxed">
                  Our apps span finance, nature, education, and personal growth — always with the user at the center. We believe great software should feel invisible, working quietly to make your life easier and more meaningful.
                </p>
              </div>
            </div>
          </motion.div>
              ...
              {journeyStages.map((stage, i) => (
                ...
                >
                  <div className="flex flex-col items-center text-center px-3">
                    ...
                    <h3 className="font-display font-bold text-sm mt-5 mb-2 text-foreground">
                      {stage.title}
                    </h3>
      ...
      <section className="min-h-[60vh] flex items-center py-24 sm:py-32 snap-start">
        <div className="container-site w-full">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8 max-w-4xl mx-auto justify-items-center">
            {teamMembers.map((member, i) => (
              ...
              >
                <div className="w-20 h-20 rounded-full bg-primary/10 flex items-center justify-center font-display text-2xl font-bold text-primary mx-auto mb-4 transition-all duration-300 group-hover:shadow-lg group-hover:-translate-y-1">
                  {member.initials}
                </div>
