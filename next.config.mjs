...
const nextConfig = {
  ...
  async rewrites() {
    return {
      beforeFiles: [
        ...
        { source: "/privacy-policy-antiqzy-ai", destination: "/antiqzy/privacy-policy" },
        { source: "/privacy-policy-shroomzy-ai", destination: "/shroomzy/privacy-policy" },
        ...
        { source: "/antiqzy-terms-of-service", destination: "/antiqzy/terms" },
        { source: "/shroomzy-terms-of-service", destination: "/shroomzy/terms" },
  ...
  async redirects() {
    return [
      ...
      { source: "/antiqzy/privacy-policy", destination: "/privacy-policy-antiqzy-ai", permanent: true },
      { source: "/antiqzy/terms", destination: "/antiqzy-terms-of-service", permanent: true },
      { source: "/shroomzy/privacy-policy", destination: "/privacy-policy-shroomzy-ai", permanent: true },
      { source: "/shroomzy/terms", destination: "/shroomzy-terms-of-service", permanent: true },
      ...
      { source: "/antiqzyterms", destination: "/antiqzy-terms-of-service", permanent: true },
      { source: "/antiqzyprivacy", destination: "/privacy-policy-antiqzy-ai", permanent: true },
      { source: "/shroomzyterms", destination: "/shroomzy-terms-of-service", permanent: true },
      { source: "/shroomzyprivacy", destination: "/privacy-policy-shroomzy-ai", permanent: true },
